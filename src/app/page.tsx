...
import { Calendar, Users, BookOpen, ArrowRight, Heart, Sprout, Star, ShieldCheck } from "lucide-react";
    ...
    <div className="flex flex-col gap-0 pb-32 bg-cream/20">
        ...
        <div className="container mx-auto px-4 relative z-20">
          ...
          >
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-gold font-bold tracking-[0.2em] uppercase text-sm">Sacred Knowledge</span>
            </div>
            
            <h1 className="text-6xl md:text-8xl font-black text-white mb-8 leading-[1.05] tracking-tight">
              Path to <span className="text-gradient-gold">Enlightenment</span> <br />
              & Inner <span className="text-saffron">Peace</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-6">
              <Link href="/courses">
                ...
                >
                  Start Learning <ArrowRight className="ml-2 group-hover:translate-x-2 transition-transform" />
                </Button>
              </Link>
              <Link href="/teachings">
                <Button
                  size="lg"
                  variant="outline"
                  className="glass-card text-white h-16 px-10 text-xl border-2 border-gold/50 hover:bg-gold hover:text-navy transition-all rounded-full"
                >
                  Read Dhamma
                </Button>
              </Link>
      ...
      <section className="container mx-auto px-4 py-32 lotus-pattern">
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
          <div>
            <Badge className="bg-maroon/10 text-maroon hover:bg-maroon/20 mb-4 px-4 py-1">Dhamma Education</Badge>
          ...
          <Link href="/courses">
            <Button variant="ghost" className="text-maroon hover:text-gold group font-bold text-lg">
              View All Courses{" "}
                ...
                <CardContent className="p-10">
                  ...
                  <div className="flex flex-col gap-4 text-sm text-navy/70 mb-10">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className="font-semibold text-navy/90">{course.teacher?.name || "Venerable Monk"}</span>
                    </div>
                  </div>
              ...
              >
                <div className="relative w-full md:w-2/5 aspect-4/3 md:aspect-auto">
                  ...
                  <div className="absolute bottom-4 left-4 bg-maroon text-white font-black px-4 py-2 rounded-xl text-center shadow-lg border border-gold/30">
                     <span className="block text-2xl leading-none">{new Date(event.date).getDate()}</span>
                     <span className="block text-[10px] uppercase">{new Date(event.date).toLocaleDateString("en-US", { month: "short" })}</span>
                  </div>
                </div>
                <div className="flex-1 p-8 flex flex-col justify-center">
                  ...
                  <Button variant="outline" className="w-fit border-white/20 hover:border-gold text-white hover:bg-gold hover:text-navy rounded-full transition-all">
                    Event Details
                  </Button>
                </div>
              </motion.div>
        ...
        <div className="gradient-hero rounded-[4rem] p-12 md:p-32 flex flex-col items-center text-center relative overflow-hidden text-white border-8 border-gold/30 shadow-[0_50px_100px_rgba(128,0,32,0.4)]">
          ...
          >
            ...
            <h2 className="text-5xl md:text-7xl font-black mb-8 leading-tight tracking-tight">
              Support the <br /> <span className="text-gradient-gold">Gift of Dhamma</span>
            </h2>
            
            <p className="text-xl md:text-2xl text-cream/80 max-w-3xl mx-auto mb-12 font-medium leading-relaxed">
              Your dana helps us provide free Buddhist education and maintain this
              online sanctuary. Help us keep the light of wisdom burning for all.
            </p>
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
              ...
              >
                Donate Now <ArrowRight className="ml-3 group-hover:translate-x-2 transition-transform" />
              </Button>
              <span className="text-cream/50 font-bold uppercase tracking-widest text-sm">Every donation counts</span>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <footer className="mt-32 pt-20 pb-10 border-t border-gold/10">
         <div className="container mx-auto px-4 text-center">
            <div className="flex items-center justify-center gap-4 mb-10">
               ...
               <span className="text-3xl font-black text-maroon tracking-tighter uppercase">Dhamma School</span>
            </div>
            ...
            <p className="text-navy/30 text-[10px] uppercase tracking-[0.3em] font-bold">
               © {new Date().getFullYear()} Dhamma School Myanmar. All Rights Reserved.
            </p>
         </div>
      </footer>
    </div>
