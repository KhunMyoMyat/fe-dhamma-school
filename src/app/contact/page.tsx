          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 items-start">
            ...
            <div className="lg:col-span-2 space-y-10">
              <div className="p-10 rounded-[3rem] bg-white border border-gold/10 shadow-2xl relative overflow-hidden group">
                ...
                <h3 className="text-2xl font-black text-maroon mb-10">
                  Office Information
                </h3>
                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-6">
                    ...
                    <div>
                      <p className="text-xs font-black text-gold uppercase tracking-widest mb-1">
                        {t("contact.info.address")}
                      </p>
                      <p className="text-navy/70 font-bold">
                        123 Pagoda Road, Yangon, Myanmar
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-6">
                    ...
                    <div>
                      <p className="text-xs font-black text-maroon uppercase tracking-widest mb-1">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-3">
                      <label className="text-xs font-black text-maroon uppercase tracking-widest ml-1">
                        {t("contact.form.name")}
                      </label>
                      <Input
                        required
