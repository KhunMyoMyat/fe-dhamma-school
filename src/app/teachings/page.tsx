...
export default function TeachingsPage() {
  ...
  const filteredTeachings = teachings.filter((teaching) => {
    ...
    if (selectedCategory === "dhamma_book" && !teaching.documentUrl)
      return false;

    const translations = Array.isArray(teaching.translations)
    ...
    const matchesCategory =
      ...
      (teaching.category &&
        teaching.category.toLowerCase() === selectedCategory);
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-navy/70 leading-relaxed max-w-2xl mx-auto">
            Explore Buddha's teachings and access books you can read online or
            download for later practice.
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center p-20 border-4 border-dashed border-maroon/10 rounded-[3rem] bg-white/50 backdrop-blur-sm">
            ...
            <h2 className="text-3xl font-bold text-maroon mb-4">
              Dhamma Articles Coming Soon
            </h2>
            <p className="text-navy/50 text-center max-w-md">
              Our library of sacred texts and wise reflections is currently
              being indexed for better wisdom discovery.
            </p>
          </div>
        ) : (
          <>
                ...
                <div className="flex items-center gap-3">
                  <div className="relative">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setSelectedLanguage(
                          e.target.value as "all" | "mm" | "en" | "th",
                        )
                      }
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isZero &&
                          "opacity-40 cursor-not-allowed border-gold/5 bg-cream/20 text-navy/30",
            ...
            {filteredTeachings.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                {sortedTeachings.map((teaching, index) => {
                  ...
                  const isBook =
                    String(teaching.category || "").toLowerCase() ===
                    "dhamma_book";
                  return (
                    <motion.div
                      key={teaching.id}
